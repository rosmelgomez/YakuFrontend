...
export const metadata = {
  title: "Verificación de Correo - Yaku",
  description: "Verifica tu correo electrónico para ingresar a Yaku",
};
    ...
    <div className="auth-page-wrapper">
      <Container size="1" style={{ width: "100%" }}>
        ...
        <Box style={{ display: "flex", justifyContent: "center" }}>
          <Suspense fallback={<div style={{ color: "white", textAlign: "center" }}>Cargando verificación...</div>}>
            <VerificarCorreoClient />
          </Suspense>
        </Box>

        <Box style={{ textAlign: "center", marginTop: "2rem" }}>
          <Text size="2" style={{ color: "rgba(255, 255, 255, 0.7)" }}>
            ¿Problemas con tu verificación? → soporte@yaku.pe
          </Text>
        </Box>
      </Container>
